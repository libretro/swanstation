...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   {
      "duckstation_Controller1.ForcePopnControllerMode",
      "Controller 1 Force Pop'n Mode",
      NULL,
   ...
   {
      "duckstation_Controller2.ForcePopnControllerMode",
      "Controller 2 Force Pop'n Mode",
      NULL,
      "Forces the Digital Controller to act as a Pop'n Controller.",
      NULL,
      "port",
   ...
   },
   {
      ...
      "Controller 5 NeGcon Steering Axis Deadzone",
      NULL,
      "Scales X coordinates relative to the center of the screen.",
      NULL,
     "port",
   ...
   },
   {
      ...
      "Controller 6 NeGcon Steering Axis Deadzone",
      NULL,
      "Scales X coordinates relative to the center of the screen.",
      NULL,
     "port",
   ...
   },
   {
      ...
      "Controller 7 NeGcon Steering Axis Deadzone",
      NULL,
      "Scales X coordinates relative to the center of the screen.",
      NULL,
     "port",
   ...
   },
   {
      ...
      "Controller 8 NeGcon Steering Axis Deadzone",
      NULL,
      "Scales X coordinates relative to the center of the screen.",
      NULL,
     "port",
