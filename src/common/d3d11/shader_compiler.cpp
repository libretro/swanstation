...
ComPtr<ID3DBlob> CompileShader(Type type, D3D_FEATURE_LEVEL feature_level, std::string_view code, bool debug)
{
  ...
  switch (feature_level)
  {
    ...
    {
      static const char* targets[4] = {"vs_4_0", "gs_4_0", "ps_4_0", "cs_4_0"};
    ...
    {
      static const char* targets[4] = {"vs_4_1", "gs_4_1", "ps_4_1", "cs_4_1"};
      target = targets[static_cast<int>(type)];
    }
    break;
    ...
    {
      static const char* targets[4] = {"vs_5_0", "gs_5_0", "ps_5_0", "cs_5_0"};
      target = targets[static_cast<int>(type)];
    }
    break;
    ...
    default:
    {
      static const char* targets[4] = {"vs_5_1", "gs_5_1", "ps_5_1", "cs_5_1"};
      target = targets[static_cast<int>(type)];
    }
    break;
  }
